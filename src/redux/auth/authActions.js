...
export const fetchLoginStatus=()=>{
    return (dispatch)=>{
        ...
        axios.get("http://localhost:8000/auth/login-status").then((response)=>{
...
export const login=(data,alert,navigate)=>{
    ...
    return (dispatch)=>{
        ...
        axios.post('http://localhost:8000/auth/login',JSON.stringify(data),config).then((response)=>{
...
export const logout=(alert,navigate)=>{
    return (dispatch)=>{
        axios.get('http://localhost:8000/auth/logout').then((response)=>{
